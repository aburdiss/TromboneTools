            ...
            VStack(alignment: .leading) {
                ...
                Group {
                    HStack {
                        ...
                        ImagePurchaseLink(flowStudiesBassLink, "flowStudiesBassLink")
                        Spacer()
                    }
