        ...
        ScrollView(.vertical) {
            VStack(alignment: .leading) {
                Group {
                    ...
                    // TODO: Embed the links inline using this class:
                    // https://www.hackingwithswift.com/example-code/system/how-to-make-tappable-links-in-nsattributedstring
                    
                    // "Neotech" and "other possibilities"
                    //https://www.google.com/search?q=trombone+rest+bar&client=firefox-a&hs=7FW&rls=org.mozilla:en-US:official&channel=sb&tbm=isch&tbo=u&source=univ&sa=X&ei=B4ZvU7nFJsPboATo04LwBg&ved=0CDEQsAQ&biw=1234&bih=702
                    //http://neotechstraps.com/trombone-grip.html
